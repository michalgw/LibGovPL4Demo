...
begin
  ...
  begin
    ...
    JPKRSAProd := Backend.CreateRSAPublicKey(ComboBoxRSAEnc.Text, FileNameEditJPKRSAProd.Text, lgcETPEM);
    try
  ...
  begin
    ...
    if ComboBoxRandGen.ItemIndex >= 0 then
      RandomGeneratorClass := ComboBoxRandGen.Text;
    KSeFRSAProd := Backend.CreateRSAPublicKey(ComboBoxRSAEnc.Text, FileNameEditKSeFRSAProd.Text, lgcETPEM);
    KSeFRSADemo := Backend.CreateRSAPublicKey(ComboBoxRSAEnc.Text, FileNameEditKSeFRSADemo.Text, lgcETPEM);
    KSeFRSATest := Backend.CreateRSAPublicKey(ComboBoxRSAEnc.Text, FileNameEditKSeFRSATest.Text, lgcETPEM);
