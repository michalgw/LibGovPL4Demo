...
uses
  ...
  Dialogs, Buttons, StdCtrls, LibGovPL4Backend;
...
type
  ...
  public
    { Public declarations }
    class function Execute(var ACertFile, APrivKeyFile, APassword: String; var ACertFmt, AKeyFmt: TlgoEncodingType): Boolean;
  end;
...
class function TFormCertLoad.Execute(var ACertFile, APrivKeyFile, APassword: String;
  var ACertFmt, AKeyFmt: TlgoEncodingType): Boolean;
begin
  ...
  begin
    ...
    begin
      ...
      ACertFmt := TlgoEncodingType(ComboBoxCertFmt.ItemIndex);
      APrivKeyFile := FileNameEditKey.Text;
      AKeyFmt := TlgoEncodingType(ComboBoxKeyFmt.ItemIndex);
