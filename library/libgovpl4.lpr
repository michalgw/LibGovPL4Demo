...
exports
  ...
  lgpKSeF2_GetIp4Address,
  lgpKSeF2_SetIp4Address,
  lgpKSeF2_GetIp4Range,
  lgpKSeF2_SetIp4Range,
  lgpKSeF2_GetIp4Mask,
  lgpKSeF2_SetIp4Mask,
  ...
  lgpKSeF2_PermissionsPersonsGrant,
  lgpKSeF2_PermissionsPersonsGrantSimple,
  lgpKSeF2_PermissionsEntitiesGrants,
  lgpKSeF2_PermissionsEntitiesGrantsSimple,
  lgpKSeF2_PermissionsAuthorizationsGrants,
  lgpKSeF2_PermissionsAuthorizationsGrantsSimple,
  lgpKSeF2_PermissionsIndirectGrants,
  lgpKSeF2_PermissionsIndirectGrantsSimple,
  lgpKSeF2_PermissionsSubunitsGrants,
  lgpKSeF2_PermissionsSubunitsGrantsSimple,
  lgpKSeF2_PermissionsEuEntitiesAdministrationGrants,
  lgpKSeF2_PermissionsEuEntitiesAdministrationGrantsSimple,
  lgpKSeF2_PermissionsEuEntitiesGrants,
  lgpKSeF2_PermissionsEuEntitiesGrantsSimple,

  lgpKSeF2_PermissionsCommonRevoke,
  lgpKSeF2_PermissionsCommonRevokeSimple,
  lgpKSeF2_PermissionsAuthorizationsRevoke,
  lgpKSeF2_PermissionsAuthorizationsRevokeSimple,

  lgpKSeF2_PermissionsOperationsStatus,
  lgpKSeF2_PermissionsAttachmentsStatus,
  ...
  lgpKSeF2_PermissionsQueryEuEntitiesGrants,

  lgpKSeF2_CertificatesLimits,
  lgpKSeF2_CertificatesEnrollmentsData,
  lgpKSeF2_CertificatesEnrollments,
  lgpKSeF2_CertificatesEnrollmentsStatus,
  lgpKSeF2_CertificatesRetrieve,
  lgpKSeF2_CertificatesRetrieve2,
  lgpKSeF2_CertificatesRevoke,
  lgpKSeF2_CertificatesRevoke2,
  lgpKSeF2_CertificatesQuery,
  lgpKSeF2_CertificatesQuery2,

  lgpKSeF2_LimitsContext,
  lgpKSeF2_LimitsSubject,
  lgpKSeF2_LimitsRate,
